...
parser.add_argument(
    ...
    "--img_path",
    type=str,
    default="/vast/palmer/home.grace/yz2379/project/Data/09_28_seg_data_all_train/train/images",
...
parser.add_argument(
    ...
    "--gt_path",
    type=str,
    default="/vast/palmer/home.grace/yz2379/project/Data/09_28_seg_data_all_train/train/labels",
...
parser.add_argument(
    ...
    "--npz_path",
    type=str,
    default="/vast/palmer/home.grace/yz2379/project/Data/09_28_seg_data_all_train_b_cv2Resize_processed",
...
parser.add_argument(
    "--checkpoint",
    type=str,
    default="/vast/palmer/home.grace/yz2379/project/Data/sam_vit_b_01ec64.pth",
    #default="/vast/palmer/home.grace/yz2379/project/Data/sam_vit_h_4b8939.pth",
    help="checkpoint",
)
...
def process(gt_name: str, image_name: str):
    ...
    gt_data[0:360,:,:] = io.imread(join(args.gt_path, gt_name))
    ...
    ## this is much faster
    gt_data = cv2.resize(
        np.asarray(gt_data > 0, dtype="uint8"),
        (args.image_size, args.image_size),
    )
    ...
    if np.sum(gt_data) > 100:  # exclude tiny objects
        ...
        image_data[0:360,:,:] = io.imread(join(args.img_path, image_name))
